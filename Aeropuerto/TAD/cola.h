...
typedef TIPOELEMENTO TIPOELEMENTOCOLA;

/** Estructura para la cola **/
typedef void *TCOLA;

/**
 * Reserva memoria para una cola de datos con el tipo [TIPOELEMENTO].
 *
...
/**
 * Devuelve la longitud de la cola que se pasa por referencia
 *
 * @param c
 * @return longitud de la cola
 */
int longitudCola(TCOLA c);
